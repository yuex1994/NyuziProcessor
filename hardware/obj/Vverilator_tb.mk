...
VM_PREFIX = Vverilator_tb
# Module prefix (from --prefix)
VM_MODPREFIX = Vverilator_tb
...
include Vverilator_tb_classes.mk
...
verilator_main.o: testbench/verilator_main.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
Vverilator_tb: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
