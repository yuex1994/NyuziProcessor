...
class Vverilator_tb__Syms : public VerilatedSyms {
  public:
    ...
    // SUBCELL STATE
    Vverilator_tb*                 TOPp;
    Vverilator_tb_verilator_tb     TOP__verilator_tb;
    Vverilator_tb_axi4_interface   TOP__verilator_tb__axi_bus_m__BRA__0__KET__;
    Vverilator_tb_axi4_interface   TOP__verilator_tb__axi_bus_m__BRA__1__KET__;
    Vverilator_tb_axi4_interface   TOP__verilator_tb__axi_bus_s__BRA__0__KET__;
    Vverilator_tb_axi4_interface   TOP__verilator_tb__axi_bus_s__BRA__1__KET__;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__0__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__10__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__11__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__12__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__13__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__14__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__15__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__1__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__2__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__3__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__4__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__5__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__6__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__7__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__8__KET____DOT__rom;
    Vverilator_tb_reciprocal_rom   TOP__verilator_tb__nyuzi__DOT__core_gen__BRA__0__KET____DOT__core__DOT__int_execute_stage__DOT__lane_alu_gen__BRA__9__KET____DOT__rom;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__nyuzi__DOT__interconnect_io_bus;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__nyuzi__DOT__perf_io_bus;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__nyuzi_io_bus;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__peripheral_io_bus__BRA__1__KET__;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__peripheral_io_bus__BRA__2__KET__;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__peripheral_io_bus__BRA__3__KET__;
    Vverilator_tb_io_bus_interface TOP__verilator_tb__peripheral_io_bus__BRA__5__KET__;
    Vverilator_tb_sim_sdram__C8    TOP__verilator_tb__memory;
    ...
    VerilatedScope __Vscope_verilator_tb__sdram_controller;
    VerilatedScope __Vscope_verilator_tb__sdram_controller__load_fifo;
    VerilatedScope __Vscope_verilator_tb__sdram_controller__store_fifo;
